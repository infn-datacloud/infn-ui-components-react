...
function NextPage(props: Readonly<{ page: number; totalPages: number }>) {
  ...
  return (
    <div>
      <div className="flex size-8 items-center justify-center rounded-full border-3 border-gray-400 bg-transparent text-gray-400">
        {page + 1}
      </div>
      <div
        className="dark:border-secondary/30 m-auto h-12 w-0 border-l-3 border-gray-400 data-[last=true]:hidden"
...
export function Stepper(props: Readonly<StepperProps>) {
  ...
  return (
    <div className={`flex w-min flex-col font-bold ${className}`}>
      <PreviousPages />
