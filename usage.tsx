...
export default function Home() {
    ...
    return (
        <div className='p-8 md:ml-80 pb-20 gap-16 sm:p-20 bg-gray-100'>
            <main className='flex flex-col gap-[16px] row-start-2 items-center sm:items-start'>
                ...
                >
                    <p>
                        ...
                        Donec cursus turpis odio, sit amet semper diam viverra
                        vitae. Cras fermentum mauris ex, sit amet vehicula
                        sapien placerat rhoncus. Quisque non congue massa, et
                        bibendum risus.
                    </p>
                </ConfirmModal>
                <br />
                ...
                <Form>
                    <Field>
                        <Description>
                            This is a description for the form.
                        </Description>
                    </Field>
                    <Field>
                        ...
                        >
                            <SelectOption
                                value={{ id: 'option1', name: 'Option 1' }}
                            >
                                Option 1
                            </SelectOption>
                            <SelectOption
                                value={{ id: 'option2', name: 'Option 2' }}
                            >
                                Option 2
                            </SelectOption>
                            <SelectOption
                                value={{ id: 'option3', name: 'Option 3' }}
                            >
                                Option 3
                            </SelectOption>
                        </Select>
                ...
                <h2>Toaster</h2>
                <ToasterPortal notification={{message: 'test message', subtitle: 'subtitle', type: 'success'}}></ToasterPortal>
                <br />
            </main>
